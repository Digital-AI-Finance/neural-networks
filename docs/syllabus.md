...
### Part 1: Foundations (Topics 1, 2, 11, 12, 13)
**Objective:** Understand the basic building blocks of neural networks

| Topic | Title | Key Concept |
|-------|-------|-------------|
| 01 | Biological vs Artificial Neuron | Biological inspiration |
| 02 | Single Neuron Computation | Weighted sum and activation |
| 11 | Problem Visualization | Why simple rules fail |
| 12 | Decision Boundary Concept | Linear vs curved separation |
| 13 | Neuron Decision Maker | Threshold-based decisions |

### Part 2: Building Blocks (Topics 3, 4, 14, 15)
**Objective:** Master activation functions and understand limitations

| Topic | Title | Key Concept |
|-------|-------|-------------|
| 03 | Activation Functions | Sigmoid, ReLU, Tanh |
| 04 | Linear Limitation | XOR problem |
| 14 | Sigmoid Saturation | Vanishing gradient |
| 15 | Boundary Evolution | More neurons = better boundaries |

### Part 3: Network Architecture (Topics 5, 6, 16)
**Objective:** Design and understand multi-layer networks

| Topic | Title | Key Concept |
|-------|-------|-------------|
| 05 | Network Architecture | Layers and parameters |
| 06 | Forward Propagation | Computing predictions |
| 16 | Feature Hierarchy | Layer abstraction |

### Part 4: Learning Process (Topics 7, 8, 17, 18)
**Objective:** Understand how networks learn from data

| Topic | Title | Key Concept |
|-------|-------|-------------|
| 07 | Loss Landscape | Error surface |
| 08 | Gradient Descent | Weight updates |
| 17 | Overfitting vs Underfitting | Training diagnostics |
| 18 | Learning Rate Comparison | Hyperparameter tuning |

### Part 5: Application (Topics 9, 10, 19, 20)
**Objective:** Apply neural networks to real business problems

| Topic | Title | Key Concept |
|-------|-------|-------------|
| 09 | Market Prediction Data | Feature engineering |
| 10 | Prediction Results | Before vs after training |
...
**Supplementary:**
- [PDF Presentation](https://github.com/Digital-AI-Finance/neural-networks/raw/main/20251128_0825_quantlet_branding.pdf) - Full slide deck
- [GitHub Repository](https://github.com/Digital-AI-Finance/neural-networks) - Source code for all visualizations

---

## Contact

This course is part of the [Digital-AI-Finance](https://github.com/Digital-AI-Finance) educational initiative.

For questions or feedback, please open an issue on the [GitHub repository](https://github.com/Digital-AI-Finance/neural-networks/issues).
