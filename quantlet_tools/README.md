...
- **[BRANDING_GUIDE.md](BRANDING_GUIDE.md)** - Complete step-by-step guide for any project
- **[README.md](README.md)** - This file (detailed technical reference)
...
- **Logo** (clickable, fully visible - 100% opaque)
- **QR code** (clickable, slightly transparent - 80% opaque)
