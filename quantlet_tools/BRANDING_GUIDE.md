...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=1.0] at (current page.south east) {
    \href{https://github.com/...}{\includegraphics[width=0.8cm]{quantlet_tools/logo/quantlet.png}}
  };
  ...
  \node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.8] at (current page.south east) {
    \href{https://github.com/...}{\includegraphics[width=0.6cm]{01_chart_folder/qr_code.png}}
  };

  % URL text (clickable)
  \node[anchor=south east,xshift=-0.3cm,yshift=0.2cm] at (current page.south east) {
    \href{https://github.com/...}{\tiny\texttt{\textcolor{gray}{01\_chart\_folder}}}
  };
\end{tikzpicture}
```
...
```python
\includegraphics[width=0.6cm]{...qr_code.png}
#                    ^^^^^ change this
```
...
# Logo (fully visible)
\node[...,opacity=1.0]
#             ^^^ logo is 100% opaque (not transparent)

# QR code (slightly transparent)
\node[...,opacity=0.8]
#             ^^^ QR is 80% opaque (20% transparent)
```
...
```python
\node[anchor=south east, font=\tiny]
#                            ^^^^^ change this
```
